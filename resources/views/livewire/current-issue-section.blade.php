<section class="container mx-auto px-4 py-12">
    @if (! $volumes || ! $currentVolume)
        <div class="text-center py-12">
            <div class="text-center py-8">Loading current issue...</div>
        </div>
    @else
        <div class="flex items-center justify-between mb-8">
            <h3 class="text-3xl font-normal text-[#6ba439]">
                Current Issue: {{ $currentVolume->name }} -
                {{ $currentVolume->date }}
            </h3>
            <a
                href="{{ url("/archive/" . $currentVolume->_id) }}"
                ...
                @forelse ($articles as $article)
                    ...
                    >
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a
                                href="{{ url("/archive/" . $currentVolume->_id . "/" . $article->_id) }}"
                            >
                                <span
